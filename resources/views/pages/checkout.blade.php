...
<div class="container">
    ...
    <div class="col-lg-8 pl-lg-0">
        ...
        <div class="attendee">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <td class="align-middle">
                    <a href="#">
                        <img src="{{url ('frontend/images/Icremove.png')}}" alt="">
                    </a>
                    </td>
                </tr>
                <tr>
        ...
        <div class="member mt-3">
            ...
            <label for="doePassport"></label>
            <div class="input-group mb-2 mr-sm-2">
                <input type="text" class="form-control datepicker" name="" id="doePassport" placeholder="DOE Passport">
            </div>
    ...
    <div class="card card-details card-right">
        ...
        <div class="bank-item pb-3">
            <img src="{{url ('frontend/images/Artboard – 1.png')}}" class="bank-image" alt="">
